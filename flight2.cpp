...
void Ticket::writeSampleData()
{
    Ticket tickets[3] = {
        Ticket("Economy", 1200.50, 1, "Alice", "Johnson", "1234567890", "alice@example.com", "A1234567", 1200.50, "10:00", "New York", "London", {19, 5, 2024}),
        Ticket("Economy", 1500.75, 2, "Bob", "Smith", "0987654321", "bob@example.com", "B7654321", 1500.75, "15:00", "Los Angeles", "Tokyo", {20, 5, 2024}),
        Ticket("Economy", 1800.00, 3, "Charlie", "Brown", "1122334455", "charlie@example.com", "C1122334", 1800.00, "20:00", "Chicago", "Paris", {21, 5, 2024})};

    for (int i = 0; i < 3; ++i)
    {
        if (tickets[i].storetic())
        {
            cout << "Stored Ticket: " << tickets[i].firstName << endl; // Debug print
        }
        else
        {
            cout << "Failed to store Ticket: " << tickets[i].firstName << endl; // Debug print
        }
    }
}
